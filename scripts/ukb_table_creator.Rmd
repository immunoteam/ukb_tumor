...
ukb_data_cancer_PCA = ukb_data_cancer_PTV_raw 
cancer_data_PCA = cancer_data_PTV_raw

save(ukb_data_cancer_PCA, file = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/ukb_data_cancer_PCA")
save(cancer_data_PTV_raw, file = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_data_PCA")
...
#PTV quantiles
```{r}
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/ukb_data_cancer_PCA")
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_data_PCA")
...
rm(ukb_data_cancer_PCA, cancer_data_PTV_raw)
...
#PTV group 0-90%
ukb_data_cancer = ukb_data_cancer %>%
  mutate(PTV_uni_groups = cut(PTV_burden, breaks = q_all[c("0%", "90%", "100%")], include.lowest = T)) 
...
cancer_data_list = lapply(X = tumors, FUN = function(t){
  ...
  tempdf %>% 
    ...
    mutate(PTV_cancer_type_3 = cut(PTV_burden,
                            ...
                            include.lowest = TRUE)) %>%
    mutate(PTV_canctype_groups = cut(PTV_burden,
...
cancer_data_list_hist = lapply(X = tumors_hist, FUN = function(t){
  ...
  tempdf %>% 
    ...
    mutate(PTV_histtype_groups = cut(PTV_burden,
...
ukb_data_cancer = ukb_data_cancer %>%
  ...
  mutate(PTVim_universal_2 = cut(PTVim, breaks = q_im_all[c("0%", "20%", "80%", "100%")], include.lowest = T)) %>% 
...
ukb_data_cancer = ukb_data_cancer %>%
  ...
  mutate(PTVtsg_universal_2 = cut(PTVtsg, breaks = q_tsg_all[c("0%", "20%", "80%", "100%")], include.lowest = T)) %>% 
...
ukb_data_cancer = ukb_data_cancer %>%
  ...
  mutate(PTVpli_universal_2 = cut(PTVpli, breaks = q_pli_all[c("0%", "20%", "80%", "100%")], include.lowest = T)) %>% 
