...
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_g1_attending")
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_g2_attending")
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_g3_attending")

cancer_PTV_coef_attending = rbind(cancer_PTV_g1_a_df, cancer_PTV_g2_a_df, cancer_PTV_g3_a_df)

save(cancer_PTV_coef_attending, file = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_attending_combined")

```

#PTV coef table: surv analysis
```{r}
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_surv_g1")
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_surv_g2")
load("C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_surv_g3")

cancer_PTV_coef_surv = rbind(cancer_PTV_surv_g1_df, cancer_PTV_surv_g2_df, cancer_PTV_surv_g3_df)

save(cancer_PTV_coef_surv, file = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_coef_surv_combined")
...
median_PTV_tumor = cancer_data %>%
  group_by(cancer_type) %>%
  summarise(median_PTV = median(PTV_burden))

median_PTV_tumor = filtered_PTVs_20 %>%
  group_by(cancer_type) %>%
  summarise(median_PTV = median(PTV_burden))
...
ukb_data_cancer %>% 
  group_by(PTV_burden, cancer_type) %>% 
  summarise(n = n()) %>% 
  View()
