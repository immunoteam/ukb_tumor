...
#PTV group 0-90%
ukb_data_cancer = ukb_data_cancer %>%
  mutate(PTV_uni_MAF1 = cut(PTV_burden_raw, breaks = q_all_MAF[c("0%", "90%", "100%")], include.lowest = T)) %>% 
  mutate(PTV_uni_MAF2 = cut(PTV_burden_raw, breaks = q_all_MAF[c("0%", "95%", "100%")], include.lowest = T))
