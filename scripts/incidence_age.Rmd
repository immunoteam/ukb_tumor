...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          sex = ukb_data_cancer$sex,
                          ethnic_group = ukb_data_cancer$ethnic_group,
                          attending = ukb_data_cancer$attending_1,
                          diag_date = ukb_data_cancer$diag_date,
                          date_of_death = ukb_data_cancer$date_of_death,
                          death_log = ukb_data_cancer$death,
                          cancer_type = ukb_data_cancer$cancer_type,
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTV_universal = ukb_data_cancer$PTV_uni_groups,
...
tumor_inc_PTVuni = lapply(X = tumors, FUN = function(i){
  ...
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTV_universal + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj <- cuminc(Surv(inc_age, inc_event) ~ PTV_universal + gender, data = unique_tempdf)
  inc_plot = 
    ggcuminc(x = inc_obj) +
    add_confidence_interval() +
    scale_ggsurvfit() +
  ...
  inc_table = tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTV_universal + gender, data = unique_tempdf), label_header = "**{time} year**",times = c(30, 40, 50, 60, 70, 80)) %>% 
...
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.pdf", width = 100, height = 150, units = "cm", limitsize = F, dpi = 600)

png("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", width = 100, height = 150, units = "cm", res = 300)
...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          ...
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTV_canctype_groups = ukb_data_cancer$PTV_canctype_groups,
                          eid = ukb_data_cancer$eid
                          )
rm(ukb_data_cancer)
cuminc_table$cancer_type[is.na(cuminc_table$cancer_type)] = "No_cancer"
...
tumor_inc_PTVcan = lapply(X = tumors, FUN = function(i){
  ...
  tempdf_x = tempdf_x[!duplicated(tempdf_x$eid), ]
  tempdf_x %<>% mutate(inc_age = round(as.numeric((diag_date - birthdate))/365.25))
  tempdf_x$PTV_canctype_groups = as.character(tempdf_x$PTV_canctype_groups)
  l = sort(unique(tempdf_x$PTV_canctype_groups))
  ...
  unique_tempdf$PTV_canctype_groups = cut(unique_tempdf$PTV_burden, breaks = cp, include.lowest = T, right = T)
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$cancer_type == i, 1, 0))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj =  cuminc(Surv(inc_age, inc_event) ~ PTV_canctype_groups + gender, data = unique_tempdf)
  ...
  inc_plot <- inc_plot +
    scale_color_manual(values = color_mapping) +
    scale_fill_manual(values = color_mapping)
  inc_table = tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTV_canctype_groups + gender, data = unique_tempdf), label_header = "**{time} year**",times = c(30, 40, 50, 60, 70, 80)) %>% 
    add_nevent(location = c("label", "level")) %>% 
    add_n(location = c("label", "level")) %>% 
    add_p() %>%
  modify_fmt_fun(p.value ~ function(x) ifelse(is.na(x), NA, format(x, digits = 3, scientific = TRUE)))
...
tumor_inc_PTVcan_plot = ggarrange(plotlist = tumor_inc_PTVcan, ncol = 2, nrow = 15)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = tumor_inc_PTVuni_plot, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_can_inc_hpop.pdf", width = 100, height = 150, units = "cm", limitsize = F, dpi = 600)
...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          ...
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTV_uni_groups = ukb_data_cancer$PTV_uni_groups,
                          eid = ukb_data_cancer$eid
                          )
rm(ukb_data_cancer)
...
tumor_hist_inc_PTVuni = lapply(X = hist_cat, FUN = function(i){
  ...
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTV_uni_groups + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj =  cuminc(Surv(inc_age, inc_event) ~ PTV_uni_groups + gender, data = unique_tempdf)
  inc_plot = ggcuminc(x = inc_obj) +
    add_confidence_interval() +
    scale_ggsurvfit() +
    xlab("Time (years)") +
  ...
  inc_plot = inc_plot +
    scale_color_manual(values = color_mapping) +
    scale_fill_manual(values = color_mapping)
  inc_table = tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTV_uni_groups + gender, data = unique_tempdf), label_header = "**{time} year**",times = c(30, 40, 50, 60, 70, 80)) %>% 
    add_nevent(location = c("label", "level")) %>% 
    add_n(location = c("label", "level")) %>% 
    add_p() %>%
  modify_fmt_fun(p.value ~ function(x) ifelse(is.na(x), NA, format(x, digits = 3, scientific = TRUE)))
...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          ...
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTV_histtype_groups = ukb_data_cancer$PTV_histtype_groups,
                          eid = ukb_data_cancer$eid
                          )
rm(ukb_data_cancer)
cuminc_table$hist_tumor_cat[is.na(cuminc_table$hist_tumor_cat)] = "No_cancer"
...
tumor_hist_inc_PTVcan = lapply(X = hist_cat, FUN = function(i){
  ...
  tempdf_x = tempdf_x[!duplicated(tempdf_x$eid), ]
  tempdf_x %<>% mutate(inc_age = round(as.numeric((diag_date - birthdate))/365.25))
  tempdf_x$PTV_histtype_groups = as.character(tempdf_x$PTV_histtype_groups)
  l = sort(unique(tempdf_x$PTV_histtype_groups))
  cp = unique(sort(unlist(sapply(X = l, FUN = function(y)  sapply(X = strsplit(y, ",")[[1]], FUN = function(x) as.numeric(str_extract(x, "\\d+")))))))
  tempdf_no_x = subset(cuminc_table, hist_tumor_cat != i)
  tempdf_no_x = tempdf_no_x[!duplicated(tempdf_no_x$eid), ]
  tempdf_no_x %<>% mutate(inc_age = case_when(
  ...
  max_number = max(unique_tempdf$PTV_burden, na.rm = TRUE)
  cp[length(cp)] = max_number
  unique_tempdf$PTV_histtype_groups = cut(unique_tempdf$PTV_burden, breaks = cp, include.lowest = T, right = T)
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$hist_tumor_cat == i, 1, 0))
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTV_histtype_groups + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj =  cuminc(Surv(inc_age, inc_event) ~ PTV_histtype_groups + gender, data = unique_tempdf)
  inc_plot = ggcuminc(x = inc_obj) +
    add_confidence_interval() +
    scale_ggsurvfit() +
    xlab("Time (years)") +
  ...
  inc_plot = inc_plot +
    scale_color_manual(values = color_mapping) +
    scale_fill_manual(values = color_mapping)
  inc_table = tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTV_histtype_groups + gender, data = unique_tempdf), label_header = "**{time} year**",times = c(30, 40, 50, 60, 70, 80)) %>% 
    add_nevent(location = c("label", "level")) %>% 
    add_n(location = c("label", "level")) %>% 
    add_p() %>%
  modify_fmt_fun(p.value ~ function(x) ifelse(is.na(x), NA, format(x, digits = 3, scientific = TRUE)))
...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          ...
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTVim_group = ukb_data_cancer$PTVim_group,
                          eid = ukb_data_cancer$eid
                          )
rm(ukb_data_cancer)
cuminc_table$hist_tumor_cat[is.na(cuminc_table$hist_tumor_cat)] = "No_cancer"
...
tumor_hist_inc_PTVim = lapply(X = hist_cat, FUN = function(i){
  ...
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$hist_tumor_cat == i, 1, 0))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj =  cuminc(Surv(inc_age, inc_event) ~ PTVim_group + gender, data = unique_tempdf)
  inc_plot = ggcuminc(x = inc_obj) +
    add_confidence_interval() +
    scale_ggsurvfit() +
    xlab("Time (years)") +
  ...
  inc_plot = inc_plot +
    scale_color_manual(values = color_mapping) +
    scale_fill_manual(values = color_mapping)
  inc_table = tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTVim_group + gender, data = unique_tempdf), label_header = "**{time} year**",times = c(30, 40, 50, 60, 70, 80)) %>% 
    add_nevent(location = c("label", "level")) %>% 
    add_n(location = c("label", "level")) %>% 
    add_p() %>%
  modify_fmt_fun(p.value ~ function(x) ifelse(is.na(x), NA, format(x, digits = 3, scientific = TRUE)))
...
tumor_hist_inc_PTVim = lapply(X = tumors, FUN = function(i){
  ...
  tempdf_x = tempdf_x[!duplicated(tempdf_x$eid), ]
  tempdf_x %<>% mutate(inc_age = round(as.numeric((diag_date - birthdate))/365.25))
  #tempdf_x$PTVim_group = as.character(tempdf_x$PTVim_group)
  #l = sort(unique(tempdf_x$PTVim_group))
  #cp = unique(sort(unlist(sapply(X = l, FUN = function(y)  sapply(X = strsplit(y, ",")[[1]], FUN = function(x) as.numeric(str_extract(x, "\\d+")))))))
  tempdf_no_x = subset(cuminc_table, cancer_type != i)
  tempdf_no_x = tempdf_no_x[!duplicated(tempdf_no_x$eid), ]
  tempdf_no_x %<>% mutate(inc_age = case_when(
  ...
  unique_tempdf = rbind(tempdf_x, tempdf_no_x)
  #unique_tempdf$PTVim_group = cut(unique_tempdf$PTV_burden, breaks = cp, include.lowest = T, right = T)
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$cancer_type == i, 1, 0))
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTVim_group + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj =  cuminc(Surv(inc_age, inc_event) ~ PTVim_group + gender, data = unique_tempdf)
  inc_plot = ggcuminc(x = inc_obj) +
    add_confidence_interval() +
...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          ...
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTVpli_group = ukb_data_cancer$PTVpli_group,
                          eid = ukb_data_cancer$eid
                          )
rm(ukb_data_cancer)
cuminc_table$cancer_type[is.na(cuminc_table$cancer_type)] = "No_cancer"
...
tumor_can_inc_PTVpli = lapply(X = tumors, FUN = function(i){
  ...
  tempdf_x = tempdf_x[!duplicated(tempdf_x$eid), ]
  tempdf_x %<>% mutate(inc_age = round(as.numeric((diag_date - birthdate))/365.25))
  #tempdf_x$PTVpli_group = as.character(tempdf_x$PTVpli_group)
  #l = sort(unique(tempdf_x$PTVpli_group))
  #cp = unique(sort(unlist(sapply(X = l, FUN = function(y)  sapply(X = strsplit(y, ",")[[1]], FUN = function(x) as.numeric(str_extract(x, "\\d+")))))))
  tempdf_no_x = subset(cuminc_table, cancer_type != i)
  tempdf_no_x = tempdf_no_x[!duplicated(tempdf_no_x$eid), ]
  tempdf_no_x %<>% mutate(inc_age = case_when(
  ...
  unique_tempdf = rbind(tempdf_x, tempdf_no_x)
  #unique_tempdf$PTVpli_group = cut(unique_tempdf$PTV_burden, breaks = cp, include.lowest = T, right = T)
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$cancer_type == i, 1, 0))
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTVpli_group + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
...
cuminc_table = data.frame(birthdate = ukb_data_cancer$birthdate,
                          ...
                          hist_tumor_cat = ukb_data_cancer$hist_tumor_cat,
                          PTV_burden = ukb_data_cancer$PTV_burden,
                          PTVtsg_group = ukb_data_cancer$PTVtsg_group,
                          eid = ukb_data_cancer$eid
                          )
rm(ukb_data_cancer)
cuminc_table$hist_tumor_cat[is.na(cuminc_table$hist_tumor_cat)] = "No_cancer"
...
tumor_hist_inc_PTVtsg = lapply(X = hist_cat, FUN = function(i){
  ...
  unique_tempdf = rbind(tempdf_x, tempdf_no_x)
  #unique_tempdf$PTVtsg_group = cut(unique_tempdf$PTV_burden, breaks = cp, include.lowest = T, right = T)
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$hist_tumor_cat == i, 1, 0))
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTVtsg_group + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_obj =  cuminc(Surv(inc_age, inc_event) ~ PTVtsg_group + gender, data = unique_tempdf)
  inc_plot = ggcuminc(x = inc_obj) +
    add_confidence_interval() +
    scale_ggsurvfit() +
    xlab("Time (years)") +
  ...
  inc_plot = inc_plot +
    scale_color_manual(values = color_mapping) +
    scale_fill_manual(values = color_mapping)
  inc_table = tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTVtsg_group + gender, data = unique_tempdf), label_header = "**{time} year**",times = c(30, 40, 50, 60, 70, 80)) %>% 
    add_nevent(location = c("label", "level")) %>% 
    add_n(location = c("label", "level")) %>% 
    add_p() %>%
  modify_fmt_fun(p.value ~ function(x) ifelse(is.na(x), NA, format(x, digits = 3, scientific = TRUE)))
