...
tumor_inc_PTVuni = lapply(X = tumors, FUN = function(i){
  ...
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTV_universal + gender, data = unique_tempdf) %>%
    ggcuminc() +
  ...
  tbl_cuminc(x = cuminc(Surv(inc_age, inc_event) ~ PTV_universal + gender, data = unique_tempdf), times = c(50, 60, 70, 80))
})

tumor_inc_PTVuni_plot = wrap_plots(tumor_inc_PTVuni, ncol = 6, nrow = 5)
ggarrange(plotlist = tumor_inc_PTVuni, ncol = 6, nrow = 5)
...
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)

png("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", width = 150, height = 100, units = "cm", res = 300)
...
tumor_inc_PTVcan = lapply(X = tumors, FUN = function(i){
  ...
  unique_tempdf$inc_event = as.factor(ifelse(unique_tempdf$cancer_type == i, 1, 0))
  #formula = as.formula(paste("Surv(inc_age, inc_event) ~", "PTV_canctype_groups + gender", unique_tempdf))
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTV_canctype_groups + gender, data = unique_tempdf) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
...
ggarrange(plotlist = tumor_inc_PTVcan, ncol = 6, nrow = 5)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = tumor_inc_PTVuni_plot, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_can_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)

png("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_can_inc.png", width = 150, height = 100, units = "cm", res = 300)
print(tumor_inc_PTVuni_plot)
dev.off()
...
tumor_hist_inc_PTVuni = lapply(X = hist_cat, FUN = function(i){
  ...
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTV_uni_groups + gender, data = unique_tempdf) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
    add_risktable(risktable_stats = "n.risk") +
...
ggarrange(plotlist = tumor_hist_inc_PTVuni, ncol = 3, nrow = 2)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = tumor_inc_PTVuni_plot, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_hist_uni_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)
...
tumor_hist_inc_PTVcan = lapply(X = hist_cat, FUN = function(i){
  ...
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTV_histtype_groups + gender, data = unique_tempdf) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
    add_risktable(risktable_stats = "n.risk") +
...
ggarrange(plotlist = tumor_hist_inc_PTVcan, ncol = 3, nrow = 2)
...
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_hist_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)

png("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_hist_inc.png", width = 150, height = 100, units = "cm", res = 300)
print(tumor_hist_inc_PTVcan)
dev.off()
...
tumor_hist_inc_PTVim = lapply(X = hist_cat, FUN = function(i){
  ...
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTVim_group + gender, data = unique_tempdf) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
    add_risktable(risktable_stats = "n.risk") +
...
#tumor_inc_PTVcan_plot = wrap_plots(tumor_hist_inc_PTVcan, ncol = 3, nrow = 2)
ggarrange(plotlist = tumor_hist_inc_PTVim, ncol = 3, nrow = 2)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = PTV_hist_inc.pdf, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVim_hist_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)
...
#tumor_inc_PTVcan_plot = wrap_plots(tumor_hist_inc_PTVcan, ncol = 3, nrow = 2)
ggarrange(plotlist = tumor_hist_inc_PTVim, ncol = 6, nrow = 5)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = PTV_hist_inc.pdf, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVim_can_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)
...
tumor_can_inc_PTVpli = lapply(X = tumors, FUN = function(i){
  ...
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTVpli_group + gender, data = unique_tempdf) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
    add_risktable(risktable_stats = "n.risk") +
...
#tumor_inc_PTVcan_plot = wrap_plots(tumor_hist_inc_PTVcan, ncol = 3, nrow = 2)
ggarrange(plotlist = tumor_can_inc_PTVpli, ncol = 6, nrow = 5)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = PTV_hist_inc.pdf, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVpli_can_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)
...
#tumor_inc_PTVcan_plot = wrap_plots(tumor_hist_inc_PTVcan, ncol = 3, nrow = 2)
ggarrange(plotlist = tumor_hist_inc_PTVpli, ncol = 3, nrow = 2)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = PTV_hist_inc.pdf, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVpli_hist_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)
...
tumor_hist_inc_PTVtsg = lapply(X = hist_cat, FUN = function(i){
  ...
  tempdf_x = tempdf_x[!duplicated(tempdf_x$eid), ]
  tempdf_x %<>% mutate(inc_age = round(as.numeric((diag_date - birthdate))/365.25))
  #tempdf_x$PTVtsg_group = as.character(tempdf_x$PTVtsg_group)
  #l = sort(unique(tempdf_x$PTVtsg_group))
  #cp = unique(sort(unlist(sapply(X = l, FUN = function(y)  sapply(X = strsplit(y, ",")[[1]], FUN = function(x) as.numeric(str_extract(x, "\\d+")))))))
  tempdf_no_x = subset(cuminc_table, hist_tumor_cat != i)
  tempdf_no_x = tempdf_no_x[!duplicated(tempdf_no_x$eid), ]
  tempdf_no_x %<>% mutate(inc_age = case_when(
  ...
  unique_tempdf$gender = as.factor(unique_tempdf$gender)
  inc_plot = cuminc(Surv(inc_age, inc_event) ~ PTVtsg_group + gender, data = unique_tempdf) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
    add_risktable(risktable_stats = "n.risk") +
...
#tumor_inc_PTVcan_plot = wrap_plots(tumor_hist_inc_PTVcan, ncol = 3, nrow = 2)
ggarrange(plotlist = tumor_hist_inc_PTVtsg, ncol = 3, nrow = 2)
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = PTV_hist_inc.pdf, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVtsg_hist_inc.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)
...
tumor_can_inc_PTVtsg = lapply(X = tumors, FUN = function(i){
  ...
  grid.arrange(inc_plot, inc_table_grob, layout_matrix = rbind(c(1, 1), c(1,1), c(2, 2)))
})
...
#save_plot(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_uni_inc.png", plot = PTV_hist_inc.pdf, base_width = 150, base_height = 100, units = "cm", limitsize = F, dpi = 300)
ggsave("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVtsg_can_inc_fin.pdf", width = 150, height = 100, units = "cm", limitsize = F, dpi = 600)

png("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTVtsg_inc.png", width = 150, height = 100, units = "cm", res = 300)
...
png("C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Age incidence/PTV_hist_inc_tbl.png", width = 150, height = 100, units = "cm", res = 300)
print(tumor_inc_PTVtsg)
dev.off()
...
cuminc(Surv(time, event) ~ PTVtsg_group + gender, data = cuminc_table) %>%
    ggcuminc() +
    add_pvalue(location = "annotation") +
    add_confidence_interval() +
    add_risktable(risktable_stats = "n.risk") +
    scale_ggsurvfit() +
    xlab("Time (years)") +
    ggtitle("Incidence of any tumor") +
    theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"), 
          legend.position = "right")
