...
library(magrittr)
library(gridExtra)
oíptions(dplyr.summarise.inform = F)
```
...
PTV_cox_forest = ggarrange(plotlist = PTV_tumor_forest_plot, ncol = 9, nrow = 3)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/cancer_type_ptv_forest.png", plot = PTV_cox_forest, width = 150, height = 80, units = "cm", limitsize = F, dpi = 300)
...
i = 0
PTV_tumor_forest_plot = lapply(X = hist_cat, FUN = function(x){
  i = i + 1
  .GlobalEnv$i = i
...
PTV_cox_forest = ggarrange(plotlist = PTV_tumor_forest_plot, ncol = 3, nrow = 2)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/hist_tumor_cat_forest.png", plot = PTV_cox_forest, width = 120, height = 40, units = "cm", limitsize = F, dpi = 300)
...
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/tumor_cat_PTV_universal_1.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 3, nrow = 2)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/tumor_cat_PTV_universal_2.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 3, nrow = 2)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/tumor_cat_PTV_tumor_cat_1.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 3, nrow = 2)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/tumor_cat_PTV_tumor_cat_2.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 3, nrow = 2)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/tumor_cat_PTV_tumor_cat_3.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 5, nrow = 5)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/cancer_type_PTV_universal_1.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 5, nrow = 5)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/cancer_type_PTV_universal_2.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 5, nrow = 5)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/cancer_type_PTV_cancer_type_1.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
ggarrange(plotlist =  plotlist_PTV3, ncol = 5, nrow = 5)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_birth/cancer_type_PTV_cancer_type_2.png", width = 170, height = 70, units = "cm", dpi = 300, limitsize = F)
...
m = ukb_data_cancer %>% 
  filter(tumor_cat == "No_cancer") %>% 
  pull(PTV_burden) %>% 
  median()

PTV_tumor_his_median = lapply(X = unique(ukb_data_cancer$tumor_cat), FUN = function(x){
  temp_df = ukb_data_cancer %>% filter(tumor_cat == x)
  ggplot(temp_df, aes(x = PTV_burden)) +
    geom_histogram(binwidth = 1, color = "black", fill = "skyblue", alpha = 0.6) + 
    labs(title = paste0("Number of PTV burden in ", x), x = "PTV", y = "Count") +
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
...
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/tumor_cat_hist_median.png", plot = PTV_tumor_his_median, width = 80, height = 40, units = "cm", dpi = 300)
