...
cancer_PTV_cox = do.call(rbind, result_list)
save(cancer_PTV_cox,file = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_cox")
...
cancer_PTV_cox = do.call(rbind, result_list)
save(cancer_PTV_cox,file = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/objects/cancer_PTV_cox_sex_ethnic")
...
i = 0
PTV_tumor_forest_plot = lapply(X = unique(ukb_data_cancer$cancer_type), FUN = function(x){
  i = i + 1
  .GlobalEnv$i = i
  tempdf_x = subset(ukb_data_cancer, cancer_type == x)
  tempdf_x = dplyr::arrange(tempdf_x, diag_date)
  ...
  ggforest(hr_model, data = unique_tempdf)  
})

PTV_cox_forest = ggarrange(plotlist = PTV_tumor_forest_plot, ncol = 9, nrow = 3)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/ptv_forest.jpg", plot = PTV_cox_forest, width = 150, height = 80, units = "cm", limitsize = F, dpi = 300)
