...
```{r}
fun_TumorSurvCoxDS_WithSmokingStat = function(tumor = "all", gender = "all", geneset = c("ENSG00000104804"), ptv_burden_cat = TRUE, gpca_nb = 10, threads, dataset_dir = "/media/balazs/WorkL/balazs/Work/UKBiobank/Objects/000_Sub_datasets/", ptv_dir = "/media/balazs/WorkL/balazs/Work/UKBiobank/PTVvars/") {
  tumor_data = bind_rows(lapply(tumor, function(tmr) {
    if(tmr == "all" & gender == "all") {
      tmr_data = readRDS(paste0(dataset_dir, "tumorous_all.rds"))
    } else if(tmr == "all" & gender != "all") {
...
fun_TumorSurvCoxDS_NeverSmokers = function(tumor = "all", gender = "all", geneset = c("ENSG00000104804"), ptv_burden_cat = TRUE, gpca_nb = 10, threads, dataset_dir = "/media/balazs/WorkL/balazs/Work/UKBiobank/Objects/000_Sub_datasets/", ptv_dir = "/media/balazs/WorkL/balazs/Work/UKBiobank/PTVvars/") {
  tumor_data = bind_rows(lapply(tumor, function(tmr) {
    if(tmr == "all" & gender == "all") {
      tmr_data = readRDS(paste0(dataset_dir, "tumorous_all.rds"))
    } else if(tmr == "all" & gender != "all") {
...
genesets$survDSCoxHR_withSmokinStat = future_sapply(genesets$genes, function(x) fun_TumorSurvCoxDS_WithSmokingStat(tumor = "Lung", gender = "male", geneset = strsplit(x, ";")[[1]])["HR"])
genesets$survDSCoxPvalue_withSmokinStat = future_sapply(genesets$genes, function(x) fun_TumorSurvCoxDS_WithSmokingStat(tumor = "Lung", gender = "male", geneset = strsplit(x, ";")[[1]])["Pvalue"])

genesets$survDSCoxHR_NeverSmokers = future_sapply(genesets$genes, function(x) fun_TumorSurvCoxDS_NeverSmokers(tumor = "Lung", gender = "male", geneset = strsplit(x, ";")[[1]])["HR"])
genesets$survDSCoxPvalue_NeverSmokers = future_sapply(genesets$genes, function(x) fun_TumorSurvCoxDS_NeverSmokers(tumor = "Lung", gender = "male", geneset = strsplit(x, ";")[[1]])["Pvalue"])
