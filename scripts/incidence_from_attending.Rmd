...
PTV_attending_cox_forest = ggarrange(plotlist = PTV_tumor_attending_forest_plot, ncol = 4, nrow = 2)
ggsave(filename = "C:/Users/bagil/Desktop/MyGit/ukb_tumor/plots/Incidence/Incidence_from_attending/tumor_cat_forest_a.png", plot = PTV_attending_cox_forest, width = 90, height = 70, units = "cm", limitsize = F, dpi = 300)
...
ggarrange(plotlist =  plotlist_PTV1, ncol = 6, nrow = 5)
