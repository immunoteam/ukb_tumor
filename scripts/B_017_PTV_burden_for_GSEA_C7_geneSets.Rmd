...
res_fishtest = readRDS("Res/010/res_fishtest_104.rds")
res_fishtest %>% filter(SYMBOL %in% FRANCOsymbols) %>% filter(category %in% c("Melanoma", "Lung", "Bladder", "Kidney", "Brain", "Ovary", "Pancreas")) %>% View()

fun_TumorIncCoxModel(tumor = "Lung", gender = "male", geneset = FRANCOensgs)
fun_TumorIncFishTest(tumor = "Lung", gender = "male", geneset = FRANCOensgs)
fun_TumorIncForestPlot(tumor = "Lung", gender = "male", geneset = FRANCOensgs)
fun_TumorIncStat(tumor = "Lung", gender = "male", geneset = FRANCOensgs)
fun_TumorSurvPlotDS(tumor = "Lung", gender = "male", geneset = FRANCOensgs)
...
fun_TumorIncForestPlot(tumor = "Bladder", gender = "male", geneset = FRANCOensgs)
