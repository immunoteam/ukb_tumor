...
genes = geneSets[["GSE21360_NAIVE_VS_PRIMARY_MEMORY_CD8_TCELL_DN"]] #Genes down-regulated in CD8 T cells: naïve versus 1' memory.
...
fun_TumorIncForestPlot(tumor = unique(gsub("_female","", hot_tumors[grepl("female", hot_tumors)])), gender = "female", geneset = genes, gpca_nb = 10)
